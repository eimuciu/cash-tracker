...
export default function DataInflow({
  ...
  React.useEffect(() => {
    setSelectValue(selectCategory[selectCategory.indexOf(itemObj.category)]);
    setDateValue(itemObj.date);
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [selectCategory, itemObj]);

  const formik = useFormik({
    enableReinitialize: true,
    initialValues: {
      amount: itemObj.amount as string,
      note: itemObj.note as string,
    },
